 ...
 * @property {RequestPolicyInput} [requestPolicy]
 ...
 * @property {Record<string, string> | string[] | NormalizedHeaderEntry[]} [customerHeaders]
 * @property {Record<string, string> | string[] | NormalizedHeaderEntry[]} [headers]
 * @property {boolean} [enableRequestSigning]
 * @property {boolean} [sendHeadersOverHttp]
 * @property {boolean} [sendCustomerHeadersOverHttp]
 */
 ...
 * @property {boolean} enableRequestSigning
 * @property {boolean} sendCustomerHeadersOverHttp
 * @property {NormalizedHeaderEntry[]} customerHeaders
 */
